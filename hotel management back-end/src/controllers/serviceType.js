...
export const getAllServiceType = async (req, res) => {
  try {
    const serviceTypes = await executeQuery("SELECT * FROM ServiceType");
...
export const createServiceType = async (req, res) => {
  try {
    ...
    await executeQuery(
      `INSERT INTO ServiceType (ServiceTypeName, Description) VALUES (@ServiceTypeName, @Description)`,
      {
...
export const updateServiceType = async (req, res) => {
  try {
    ...
    await executeQuery(
      `UPDATE ServiceType SET ServiceTypeName = @ServiceTypeName, Description = @Description WHERE ServiceTypeID = @ServiceTypeID`,
      {
        ServiceTypeName: serviceType.ServiceTypeName,
        Description: serviceType.Description,
