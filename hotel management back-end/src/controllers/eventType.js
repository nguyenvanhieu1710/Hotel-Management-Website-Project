...
export const getAllEventType = async (req, res) => {
  try {
    const eventTypes = await executeQuery("SELECT * FROM EventType");
...
export const getEventTypeById = async (req, res) => {
  try {
    ...
    const eventType = await executeQuery(
...
export const createEventType = async (req, res) => {
  try {
    ...
    await executeQuery(
      `INSERT INTO EventType (EventTypeName, Description) VALUES (@EventTypeName, @Description)`,
      {
...
export const updateEventType = async (req, res) => {
  try {
    ...
    await executeQuery(
      `UPDATE EventType SET EventTypeName = @EventTypeName, Description = @Description, Deleted = @Deleted WHERE EventTypeID = @EventTypeId`,
      {
